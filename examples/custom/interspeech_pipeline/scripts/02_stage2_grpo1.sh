...
GRPO_DEDUPE_MAX_RETRIES="${GRPO_DEDUPE_MAX_RETRIES:-30}"
GRPO_DEDUPE_REQUIRE_VALID="${GRPO_DEDUPE_REQUIRE_VALID:-1}"
GRPO_DEDUPE_OVERLAP_REJECT="${GRPO_DEDUPE_OVERLAP_REJECT:-2}"
GRPO_DEDUPE_ID_CAP="${GRPO_DEDUPE_ID_CAP:-3}"
GRPO_DEDUPE_NON_HIT_ID_CAP="${GRPO_DEDUPE_NON_HIT_ID_CAP:-1}"
GRPO_DEDUPE_HIT_ORDER_CAP="${GRPO_DEDUPE_HIT_ORDER_CAP:-1}"
GRPO_DEDUPE_EXACT_UNIQUE="${GRPO_DEDUPE_EXACT_UNIQUE:-1}"
GRPO_RETRY_TWO_PHASE="${GRPO_RETRY_TWO_PHASE:-1}"
GRPO_RETRY_PHASE1_RATIO="${GRPO_RETRY_PHASE1_RATIO:-0.6}"
GRPO_RETRY_PHASE2_REQUIRE_GT_HIT="${GRPO_RETRY_PHASE2_REQUIRE_GT_HIT:-1}"
GRPO_RETRY_PHASE2_MIN_HITS="${GRPO_RETRY_PHASE2_MIN_HITS:-1}"
GRPO_RETRY_PHASE2_OVERLAP_RELAX_DELTA="${GRPO_RETRY_PHASE2_OVERLAP_RELAX_DELTA:-1}"
GRPO_RETRY_TEMP_PEAK="${GRPO_RETRY_TEMP_PEAK:-1.6}"
GRPO_RETRY_TOP_P_PEAK="${GRPO_RETRY_TOP_P_PEAK:-0.98}"
GRPO_DEDUPE_STRICT="${GRPO_DEDUPE_STRICT:-1}"
GRPO_DEDUPE_ONLY_WRONG_IDS="${GRPO_DEDUPE_ONLY_WRONG_IDS:-1}"
...
export GRPO_DEDUPE_ROLLOUTS="${GRPO_DEDUPE_ROLLOUTS}"
export GRPO_DEDUPE_MAX_RETRIES="${GRPO_DEDUPE_MAX_RETRIES}"
export GRPO_DEDUPE_REQUIRE_VALID="${GRPO_DEDUPE_REQUIRE_VALID}"
export GRPO_DEDUPE_OVERLAP_REJECT="${GRPO_DEDUPE_OVERLAP_REJECT}"
export GRPO_DEDUPE_ID_CAP="${GRPO_DEDUPE_ID_CAP}"
export GRPO_DEDUPE_NON_HIT_ID_CAP="${GRPO_DEDUPE_NON_HIT_ID_CAP}"
export GRPO_DEDUPE_HIT_ORDER_CAP="${GRPO_DEDUPE_HIT_ORDER_CAP}"
export GRPO_DEDUPE_EXACT_UNIQUE="${GRPO_DEDUPE_EXACT_UNIQUE}"
export GRPO_RETRY_TWO_PHASE="${GRPO_RETRY_TWO_PHASE}"
export GRPO_RETRY_PHASE1_RATIO="${GRPO_RETRY_PHASE1_RATIO}"
export GRPO_RETRY_PHASE2_REQUIRE_GT_HIT="${GRPO_RETRY_PHASE2_REQUIRE_GT_HIT}"
export GRPO_RETRY_PHASE2_MIN_HITS="${GRPO_RETRY_PHASE2_MIN_HITS}"
export GRPO_RETRY_PHASE2_OVERLAP_RELAX_DELTA="${GRPO_RETRY_PHASE2_OVERLAP_RELAX_DELTA}"
export GRPO_RETRY_TEMP_PEAK="${GRPO_RETRY_TEMP_PEAK}"
export GRPO_RETRY_TOP_P_PEAK="${GRPO_RETRY_TOP_P_PEAK}"
export GRPO_DEDUPE_STRICT="${GRPO_DEDUPE_STRICT}"
export GRPO_DEDUPE_ONLY_WRONG_IDS="${GRPO_DEDUPE_ONLY_WRONG_IDS}"
